use edit_prediction::open_ai_compatible::{
    open_ai_compatible_api_token, open_ai_compatible_api_url,
};
use edit_prediction_ui::{get_available_providers, set_completion_provider};
use gpui::{App, ScrollHandle, prelude::*};
...
use crate::{
    ...
    components::SettingsSectionHeader,
    pages::edit_prediction_api_key::{ApiKeyDocs, render_api_key_provider},
};
