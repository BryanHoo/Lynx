...
Icons are a big part of Lynx, and they're how we convey hundreds of actions without relying on labeled buttons.
...
Then, they're modified, adjusted, cleaned up, and simplified depending on their use and overall fit with Lynx.
...
Make sure to tag a member of Lynx's design team (@zed-industries/design) so we can review and adjust any newly introduced icon.
