...
use cloud_api_types::{
    ...
    SettledEditPredictionSampleData, SubmitEditPredictionSettledBatchBody,
...
#[derive(Error, Debug)]
#[error(
    "You must update to Lynx version {minimum_version} or higher to continue using edit predictions."
)]
