...
use gpui::{
    App, AppContext as _, Context, Entity, EventEmitter, Subscription, Task, TaskExt, WeakEntity,
};
use language::{
...
impl BufferStore {
    ...
    pub fn create_buffer(
        ...
        self.state.create_buffer(language, project_searchable, cx)
    }
