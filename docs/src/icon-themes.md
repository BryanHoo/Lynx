---
title: Icon Themes
description: "Lynx comes with a built-in icon theme, with more icon themes available as extensions."
---

# Icon Themes

Lynx comes with a built-in icon theme, with more icon themes available as extensions.
...
More icon themes are available from the Extensions page, which you can access via the command palette with {#action zed::Extensions} or the [Lynx website](https://zed.dev/extensions?filter=icon-themes).
...
Just like with themes, Lynx allows for configuring different icon themes for light and dark mode.
...
See: [Developing Lynx Icon Themes](./extensions/icon-themes.md)
