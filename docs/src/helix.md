---
title: Helix Mode - Lynx
description: Helix-style keybindings and modal editing in Lynx. Selection-first editing built on top of Vim mode.
---
...
Lynx's Helix mode is an emulation layer that brings Helix-style keybindings and modal editing to Lynx. It builds upon Lynx's [Vim mode](./vim.md), so much of the core functionality is shared. Enabling `helix_mode` will also enable `vim_mode`.
