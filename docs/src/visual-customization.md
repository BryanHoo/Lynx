...
description: "Various aspects of Lynx's visual layout can be configured in the Settings Editor or settings file."
---

# Visual Customization

Various aspects of Lynx's visual layout can be configured in the Settings Editor ({#kb zed::OpenSettings}) or in your settings file ({#kb zed::OpenSettingsFile}).
...
By default Lynx enables font ligatures which will visually combine certain adjacent characters.
...
```json [settings]
{
  // Force usage of Lynx build in path prompts (file and directory pickers)
  // instead of OS native pickers (false).
  "use_system_path_prompts": true,
  // Force usage of Lynx built in confirmation prompts ("Do you want to save?")
...
See [Lynx AI Documentation](./ai/overview.md) for additional non-visual AI settings.
