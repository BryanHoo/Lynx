...
# Language Support in Lynx

Lynx supports hundreds of programming languages and text formats.
Some work out-of-the-box and others rely on 3rd party extensions.

> The ones included out-of-the-box, natively built into Lynx, are marked with \*.
...
- [Rust](./languages/rust.md) \* (Lynx's written in Rust)
