---
title: Editing Code in Lynx
description: Core code editing features in Lynx including multi-cursor, refactoring, code actions, and language server integration.
---

# Editing Code

Lynx provides tools to help you write and modify code efficiently. This section covers the core editing features that work alongside your language server.
...
When you're editing code, Lynx combines input from multiple sources:
