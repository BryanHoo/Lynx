---
title: Extensions
description: "Extend Lynx with themes, language support, AI tools, and more through the extension system."
---

# Extensions

Lynx lets you add new functionality using user-defined extensions.
