---
title: Getting Started with Lynx
description: Get started with Lynx, the fast open-source code editor. Essential commands, environment setup, and navigation basics.
---

# Getting Started

Lynx is an open-source code editor with built-in collaboration and AI tools.
...
When you open Lynx without a folder, you see the welcome page in the main editor area. The welcome page offers quick actions to open a folder, clone a repository, or view documentation. Once you open a folder or file, the welcome page disappears. If you split the editor into multiple panes, the welcome page appears only in the center pane when empty—other panes show a standard empty state.
...
Or use `Cmd+O` (macOS) / `Ctrl+O` (Linux/Windows) to open a folder from within Lynx.
...
The command palette (`Cmd+Shift+P`) is your gateway to every action in Lynx. If you forget a shortcut, search for it there.
...
Lynx includes built-in support for many languages. For others, install the extension:
...
Lynx includes built-in AI assistance. Open the Agent Panel with `Cmd+Shift+A` (macOS) or `Ctrl+Shift+A` (Linux/Windows) to start a conversation, or use `Cmd+Enter` (macOS) / `Ctrl+Enter` (Linux/Windows) for inline assistance.
...
- [IntelliJ IDEA](./migrate/intellij.md) — Adapt to Lynx's approach to navigation and refactoring
- [PyCharm](./migrate/pycharm.md) — Set up Python development in Lynx
- [WebStorm](./migrate/webstorm.md) — Configure JavaScript/TypeScript workflows
- [RustRover](./migrate/rustrover.md) — Rust development in Lynx
...
Lynx is open source. Join us on GitHub or in Discord to contribute code, report bugs, or suggest features.

- [Discord](https://discord.com/invite/zedindustries)
- [GitHub Discussions](https://github.com/zed-industries/zed/discussions)
- [Lynx Reddit](https://www.reddit.com/r/ZedEditor)
