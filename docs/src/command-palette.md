---
title: Command Palette - Lynx
description: Access any Lynx action from the command palette. Fuzzy search commands, key bindings, and editor actions.
---

# Command Palette

The Command Palette is the main way to access actions in Lynx. Its keybinding is one of the first shortcuts to learn: {#kb command_palette::Toggle}.
