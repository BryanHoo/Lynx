...
Use this page to choose which models power [the Lynx Agent](./zed-agent.md) and
other Lynx-owned AI features, including [Inline Assistant](./inline-assistant.md),
...
[Edit Prediction](./edit-prediction.md) has its own provider setup under `edit_predictions`. LLM providers on this page apply to model-backed Lynx AI features such as Lynx Agent, Inline Assistant, Git commit generation, and thread summaries.
