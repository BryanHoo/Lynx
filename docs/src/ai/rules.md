...
description: Rules have been replaced by Skills and Instructions in Lynx.
---
...
> **Note:** Starting in Lynx v1.4.0, on-demand Rules and the Rules Library have been replaced by [Skills](./skills.md). Skills are the recommended way to package reusable agent instructions.
...
Rules Library content is not deleted, so downgrading to an earlier version of Lynx leaves your Rules intact.
