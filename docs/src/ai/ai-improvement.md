---
title: Feedback and Training Data - Lynx
description: Understand opt-in AI feedback ratings, Edit Prediction training data, and when Lynx may retain AI data.
---

# Feedback and Training Data

Normal AI requests are not retained by Lynx. For
[Lynx-hosted models](../account/zed-hosted-models.md), provider agreements
...
This page covers the cases where Lynx may retain AI data because you explicitly
shared it or opted in.

AI features in Lynx include:
...
Lynx-hosted model zero-data-retention and no-training commitments, including the
...
You can rate AI responses or submit feedback to help improve Lynx's system prompt,
...
> If you do not want the thread persisted by Lynx, do not rate the response.

### Data Collected from Feedback {#data-collected-ai-feedback}

For conversation threads you explicitly share through ratings or feedback, Lynx
may store:
...
- metadata about your Lynx installation

If you do not rate responses or submit feedback, Lynx does not store Customer Data
related to your AI feature usage for improvement.

Telemetry related to Lynx's AI features is collected separately. This includes
...
Collected feedback data is stored in Snowflake. Lynx periodically reviews this
...
Lynx does not collect training data for the Edit Prediction model unless all of
...
in your Lynx settings file ([how to edit](../configuring-zed.md#settings-files)):
...
For open source projects where you opted in, Lynx may collect:
...
Collected data is stored in Snowflake. Lynx periodically reviews this data to
...
Lynx uses this training dataset to fine-tune
...
On Lynx Business, data sharing is off by default and controlled by organization
...
See the [Lynx Terms of Service](https://zed.dev/terms) for more.
