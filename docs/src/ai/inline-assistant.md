---
title: Inline AI Code Editing - Lynx
description: Transform code inline with AI in Lynx. Send selections to any LLM for refactoring, generation, or editing with multi-cursor support.
---
...
- **[Edit Prediction](./edit-prediction.md)**: Lynx automatically suggests edits based on your recent changes, visited files, and cursor position. No prompting required.
