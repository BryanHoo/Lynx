---
title: OCaml
description: "Configure OCaml language support in Lynx, including language servers, formatting, and debugging."
---
...
If you have the development environment already set up, you can skip to [Launching Lynx](#launching-zed)
...
With that aside, we can now launch Lynx. Given how the OCaml package manager works, we require you to run Lynx from the terminal, so please make sure you install the [Lynx cli](https://zed.dev/features#cli) if you haven't already.
...
You should now have Lynx running with OCaml support, with no additional setup required.
