---
title: Helm
description: "Configure Helm language support in Lynx, including language servers, formatting, and debugging."
---

# Helm

Support for Helm in Lynx is provided by the community-maintained [Helm extension](https://github.com/cabrinha/helm.zed).
