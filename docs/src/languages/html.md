---
title: HTML
description: "Configure HTML language support in Lynx, including language servers, formatting, and debugging."
---
...
By default Lynx uses [Prettier](https://prettier.io/) for formatting HTML.
...
You can customize various [formatting options](https://code.visualstudio.com/docs/languages/html#_formatting) for `vscode-html-language-server` via your Lynx `settings.json`:
