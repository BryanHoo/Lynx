---
title: Jsonnet
description: "Configure Jsonnet language support in Lynx, including language servers, formatting, and debugging."
---

# Jsonnet

Jsonnet language support in Lynx is provided by the community-maintained [Jsonnet extension](https://github.com/narqo/zed-jsonnet).
