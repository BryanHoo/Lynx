---
title: Bash
description: "Configure Bash language support in Lynx, including language servers, formatting, and debugging."
---

# Bash

Bash support is available natively in Lynx.
...
- [Lynx Docs: Language Support: Shell Scripts](./sh.md)
