---
title: SQL
description: "Configure SQL language support in Lynx, including language servers, formatting, and debugging."
---
...
Lynx supports auto-formatting SQL using external tools like [`sql-formatter`](https://github.com/sql-formatter-org/sql-formatter).
...
You can add this to Lynx project settings (`.zed/settings.json`) or via your Lynx user settings (`~/.config/zed/settings.json`).
...
When using a `.sql-formatter.json` file you can use a simplified Lynx settings configuration:
