---
title: PHP
description: "Configure PHP language support in Lynx, including language servers, formatting, and debugging."
---
...
The PHP extension uses [LSP language servers](https://microsoft.github.io/language-server-protocol) with Phpactor as the default. If you want to use other language servers that support Lynx (e.g. Intelephense, PHP Tools or PHPantom), make sure to follow the documentation on how to implement it.
...
Check out the documentation of [PHP Tools for Lynx](https://docs.devsense.com/other/zed/) for more details.
...
Lynx supports syntax highlighting for PHPDoc comments.
...
- Ensure that the host and port match between Xdebug and Lynx.
