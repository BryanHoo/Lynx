---
title: Haskell
description: "Configure Haskell language support in Lynx, including language servers, formatting, and debugging."
---
...
If you need to configure haskell-language-server (hls) you can add configuration options to your Lynx settings.json:
