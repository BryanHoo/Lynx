---
title: Elm
description: "Configure Elm language support in Lynx, including language servers, formatting, and debugging."
---
...
Lynx support for Elm requires installation of `elm`, `elm-format`, and `elm-review`.
