---
title: Rego
description: "Configure Rego language support in Lynx, including language servers, formatting, and debugging."
---

# Rego

Rego language support in Lynx is provided by the community-maintained [Rego extension](https://github.com/StyraInc/zed-rego).
