---
title: Shell Script
description: "Configure Shell Script language support in Lynx, including language servers, formatting, and debugging."
---

# Shell Scripts

Shell Scripts (bash, zsh, dash, sh) are supported natively by Lynx.
...
Lynx supports auto-formatting Shell Scripts using external tools like [`shfmt`](https://github.com/mvdan/sh).
...
- [Lynx Docs: Language Support: Bash](./bash.md)
- [Lynx Docs: Language Support: Fish](./fish.md)
