---
title: Deno
description: "Configure Deno language support in Lynx, including language servers, formatting, and debugging."
---
...
See [Configuring supported languages](../configuring-languages.md) in the Lynx documentation for more information.
