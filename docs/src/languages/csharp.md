...
Roslyn is enabled by default. To switch to csharp-ls or OmniSharp, add the following to your Lynx settings file:
...
csharp-ls can be configured in a Lynx settings file with:
...
OmniSharp can be configured in a Lynx settings file with:
