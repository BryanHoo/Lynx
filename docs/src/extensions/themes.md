---
title: Themes
description: "Themes for Lynx extensions."
---
...
The structure of a Lynx theme is defined in the [Lynx Theme JSON Schema](https://zed.dev/schema/themes/v0.2.0.json).

A Lynx theme consists of a Theme Family object including:
...
This tool lets you fine-tune and preview how surfaces in Lynx will look.
You can then export the JSON and publish it in Lynx's extension store.
