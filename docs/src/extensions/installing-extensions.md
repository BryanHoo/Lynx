...
description: "Browse, install, and manage extensions from the Lynx Extension Gallery."
---

# Installing Extensions {#installing-extensions}

Extensions add functionality to Lynx, including languages, themes, and AI tools. Browse and install them from the Extension Gallery.

Open the Extension Gallery with {#kb zed::Extensions}, or select "Lynx > Extensions" from the menu bar.
