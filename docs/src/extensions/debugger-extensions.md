...
description: "Debugger Extensions for Lynx extensions."
---
...
Lynx offers an automatic way to create debug scenarios with _debug locators_.
...
See DAP servers published as extensions [on Lynx's site](https://zed.dev/extensions?filter=debug-adapters).
