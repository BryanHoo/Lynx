---
title: Roles - Lynx
description: Understand Lynx's organization roles and what each role can access, manage, and configure.
---

# Roles

Every member of a Lynx organization is assigned a role that determines what they
...
- Disable Lynx's collaborative features
- Control whether members can use Lynx-hosted models and Lynx's edit predictions
...
Lynx-hosted AI models or Edit Predictions through the Business subscription.
...
Members have standard access to Lynx through the Business subscription. They
cannot access billing or organization settings.

## Managing User Roles {#managing-users}

Owners and Admins can manage organization members from the Lynx dashboard within
the Members page.
...
Removing a member removes their access to organization settings and any organization-managed features. They can continue using Lynx on their own.
