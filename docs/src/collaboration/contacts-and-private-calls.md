...
description: "Add contacts and start private collaboration sessions in Lynx."
---
...
1. Search for the contact using their GitHub handle.\
   _Note: Your contact must be an existing Lynx user who has completed the GitHub authentication sign-in flow._
