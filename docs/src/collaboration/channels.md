---
title: Channels
description: "Persistent collaboration rooms in Lynx for sharing projects, voice chat, and real-time code editing."
---
...
> **Note:** When joining a channel, Lynx automatically shares your microphone with other users in the call, if your OS allows it. To start muted, use the [`mute_on_join`](../reference/all-settings.md#calls) setting.
...
This works like a shared Markdown document backed by Lynx's collaboration service.
...
If they are following you, Lynx will automatically switch between following your cursor in their Lynx instance and your screen share, depending on whether you are focused on Lynx or another application, like a web browser.
